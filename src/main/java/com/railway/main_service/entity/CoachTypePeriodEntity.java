...
@Entity
@Table(
  name   = "coach_type_periods",
  schema = "railway_main",
  uniqueConstraints = @UniqueConstraint(
    name = "uk_coach_type_period",
    columnNames = {"type_id", "effective_from"}
  ),
  indexes = @Index(name = "idx_coach_type_period_lookup", columnList = "type_id, effective_from, effective_till")
)
public class CoachTypePeriodEntity {
  ...
  @JoinColumn(name = "type_id", nullable = false,
    foreignKey = @ForeignKey(name = "fk_coach_type_period"))
